...
userRouter.route("/editFirstName").post(
    (req,res)=> new UserController().editFirstName(req,res)
)
userRouter.route("/editLastName").post(
    (req,res)=> new UserController().editLastName(req,res)
)
userRouter.route("/editCity").post(
    (req,res)=> new UserController().editCity(req,res)
)
userRouter.route("/editCountry").post(
    (req,res)=> new UserController().editCountry(req,res)
)
